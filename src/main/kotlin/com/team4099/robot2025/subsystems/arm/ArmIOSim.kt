...
class ArmIOSim : ArmIO {
    ...
    val armPIDController: PIDController<Radian, Volt> = PIDController(
        ArmConstants.ARM_KP,
        ArmConstants.ARM_KI,
        ArmConstants.ARM_KD
    )
    ...
    override fun updateInputs(inputs: ArmIOInputs) {
        ...
        inputs.armPosition = armTargetPosition
    ...
    override fun setArmVoltage(voltage: ElectricalPotential) {
        val clampedVoltage = clamp(voltage, -ArmConstants.VOLTAGE_COMPENSATION, ArmConstants.VOLTAGE_COMPENSATION)
