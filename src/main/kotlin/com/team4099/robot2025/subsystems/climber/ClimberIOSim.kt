...
object ClimberIOSim : ClimberIO {
    private val climberSim: SingleJointedArmSim  = SingleJointedArmSim(
    ...
    private var climberController = PIDController(
    ...
    /**
     * Updates the PID slot0 constants using the implementation controller, uses arm sensor to convert from
    ...
    /**
     * Updates the PID slot1 constants using the implementation controller, uses arm sensor to convert from
     * PID constants to motor controller units
     *
     * @param kP accounts for linear error
     * @param kI accounts for integral error
    ...
    /**
     * Sets the climber motor voltage and ensures the voltage is limited to battery voltage compensation
     *
