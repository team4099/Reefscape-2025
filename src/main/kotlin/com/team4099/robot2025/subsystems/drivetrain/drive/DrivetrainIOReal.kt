    ...
    return listOf(
      SwerveModule(
        SwerveModuleIOTalon(
          ...
          CANcoder(Constants.Drivetrain.FRONT_LEFT_CANCODER),
      ...
      SwerveModule(
        SwerveModuleIOTalon(
          ...
          CANcoder(Constants.Drivetrain.FRONT_RIGHT_CANCODER),
      ...
      SwerveModule(
        SwerveModuleIOTalon(
          ...
          CANcoder(Constants.Drivetrain.BACK_LEFT_CANCODER),
      ...
      SwerveModule(
        SwerveModuleIOTalon(
          ...
          CANcoder(Constants.Drivetrain.BACK_RIGHT_CANCODER),
