...
class TrackTagCommand(
  ...
  override fun execute() {
    ...
    val angleOffFromTag = (180.degrees - lastUpdate.robotTReefTag.rotation.absoluteValue) * lastUpdate.robotTReefTag.rotation.sign
    CustomLogger.recordOutput("Vision/robotTTReefRotation", lastUpdate.robotTReefTag.rotation.inDegrees)
